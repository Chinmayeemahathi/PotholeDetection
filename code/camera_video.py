...
class_name = []
with open(os.path.join("C:/Users/hp/Desktop/POTHOLE_MAIN_DETECTION\model/project_files",'C:/Users/hp/Desktop/POTHOLE_MAIN_DETECTION/model/project_files/obj.names'), 'r') as f:
    class_name = [cname.strip() for cname in f.readlines()]

#importing model weights and config file
#defining the model parameters
net1 = cv.dnn.readNet("C:/Users/hp/Desktop/POTHOLE_MAIN_DETECTION/model/project_files/yolov4_tiny.weights","C:/Users/hp/Desktop/POTHOLE_MAIN_DETECTION/model/project_files/yolov4_tiny.cfg")
...
cap = cv.VideoCapture("C:/Users\hp/Desktop/cretificates/harika certificates/inputvideo.mp4") 
width  = cap.get(3)
height = cap.get(4)
